...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setServiceName("%sService"); //去掉Service接口的首字母I   IAccountService
        gc.setIdType(IdType.AUTO); //主键策略，AUTO数据库自增、UUID、INPUT
        ...
        dsc.setPassword("4630");  //如果你的密码不是root，改成自己密码
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
//      pc.setModuleName(scanner("模块名"));
        pc.setParent("com.go2");
        pc.setEntity("entity");   //生成实体类存入到 com.go2.entity
...
//         String templatePath = "/templates/mapper.xml.vm";
        ...
        */
        ...
        // 表名转换方式: 数据库中的下划线转成java驼峰  sys_account表--> Account类
        strategy.setNaming(NamingStrategy.underline_to_camel);
        // 列名转换方式   account_id字段名 ---  accountId
        strategy.setColumnNaming(NamingStrategy.underline_to_camel);
        strategy.setSuperEntityClass("com.go2.common.BaseEntity");  //实体类父类
        strategy.setEntityLombokModel(true);  //lombok模型
        //ResutFul风格控制器  前端请求后端
        strategy.setRestControllerStyle(true);
        // 公共父类--所有项目 控制器的父类
        strategy.setSuperControllerClass("com.go2.common.BaseController");
        // 写于父类中的公共字段
